...
def evalrank(model_path, data_path=None, split='test', fold5=False):
    """
...
# split="testall", fold5=False for MSCOCO 5K
# split="testall", fold5=True for MSCOCO1K；
# split="test", `fold5=False` for flickr30K.
# dev for val
if __name__ == '__main__':
    evalrank("/home/liuqinyi/MGLMNruns/f30k/checkpoint/model_best.pth.tar",
             data_path="/home/liuqinyi/MGLMN/data", split="test", fold5=False)
